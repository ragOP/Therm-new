...
const images = [
  "../../Assets/Images/diversity.svg",
  "../../Assets/Images/Frame 395.png",
...
function updateStory() {
  document.querySelector(
    ".diversity-title"
  ).innerHTML = `${stories[storyIndex].title} <span>${stories[storyIndex].hedingSpan}</span>`;
  document.querySelector(".diversity-desc").textContent =
